...
## TODO
- надо пере-прочитать ТЗ
- надо понять где вести history для задач
...
- наладить swagger
- обновление пользователя (user) вроде надо сделать через put (частями), туда же и картинку (multipart)
